...
def home(request):
        ...
        if request.method == "POST":
            ...
            api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode +"&distance=25&API_KEY=2986F21F-C2A5-4F71-90EF-BFB87103EC75")
            try:
            ...
            api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=90001&distance=25&API_KEY=2986F21F-C2A5-4F71-90EF-BFB87103EC75")
            try:
                api = json.loads(api_request.content)
